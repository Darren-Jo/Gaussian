...
2. Apply Gaussian Elimination to convert the matrix into an upper triangular form using row operations.
...
## Output:
<img width="726" height="411" alt="image" src="https://github.com/user-attachments/assets/a874aac5-c7c7-4703-84f2-cac47c1891fc" />
